...
def main():
    ...
    print("\nNumber of changed bits in msg: " + str(bit_num))
    print("Number of changed bits in key: " + str(key_bit_num))
...
def encrypt(key, message):
    print('\n--- Encryption ---')
    print(f'Input text (bin): \t\t' + string_to_bin(message))
    print(f'Key (bin): \t\t\t\t' + string_to_bin(key))
    ...
    print(f'Encrypted msg (bin): \t' + string_to_bin(cipher_text))
...
def decrypt(key, cipher_text):
    ...
    print(f'Encrypted msg (bin): \t' + string_to_bin(message))
